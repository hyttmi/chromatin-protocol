...
- [x] **Phase 131: Documentation Reconciliation** — PROJECT.md, PROTOCOL.md (frame/blob/NodeInfoResponse/sync-divergence), README.md, cli/README.md, db/ARCHITECTURE.md all brought in line with the shipping surface (completed 2026-04-24)
...
| 131. Documentation Reconciliation | 1/1 | Complete    | 2026-04-24 |
