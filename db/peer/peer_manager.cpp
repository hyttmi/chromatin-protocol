...
PeerManager::PeerManager(const config::Config& config,
    ...
    // Initialize metrics endpoint bind address from config
...
void PeerManager::start_metrics_listener() {
    try {
...
asio::awaitable<void> PeerManager::metrics_handle_connection(asio::ip::tcp::socket socket) {
