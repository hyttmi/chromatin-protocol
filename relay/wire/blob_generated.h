...
#ifndef FLATBUFFERS_GENERATED_BLOB_CHROMATINDB_WIRE_H_
#define FLATBUFFERS_GENERATED_BLOB_CHROMATINDB_WIRE_H_
...
inline const chromatindb::wire::Blob *GetBlob(const void *buf) {
  return ::flatbuffers::GetRoot<chromatindb::wire::Blob>(buf);
}

inline const chromatindb::wire::Blob *GetSizePrefixedBlob(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<chromatindb::wire::Blob>(buf);
}

inline bool VerifyBlobBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<chromatindb::wire::Blob>(nullptr);
}

inline bool VerifySizePrefixedBlobBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<chromatindb::wire::Blob>(nullptr);
}

inline void FinishBlobBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<chromatindb::wire::Blob> root) {
  fbb.Finish(root);
}
...
inline std::unique_ptr<chromatindb::wire::BlobT> UnPackBlob(
    const void *buf,
    const ::flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<chromatindb::wire::BlobT>(GetBlob(buf)->UnPack(res));
}

inline std::unique_ptr<chromatindb::wire::BlobT> UnPackSizePrefixedBlob(
    const void *buf,
    const ::flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<chromatindb::wire::BlobT>(GetSizePrefixedBlob(buf)->UnPack(res));
}

}  // namespace wire
}  // namespace chromatindb

#endif  // FLATBUFFERS_GENERATED_BLOB_CHROMATINDB_WIRE_H_
